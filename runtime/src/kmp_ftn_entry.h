...
void FTN_STDCALL FTN_SET_TASK_AFFINITY_INIT_THREAD_TYPE( kmp_task_aff_init_thread_type_t init_thread_type )
{
    #ifdef KMP_STUB
        // Nothing.
    #else
        __kmpc_set_task_affinity_init_thread_type( init_thread_type );
    #endif
}
#endif
