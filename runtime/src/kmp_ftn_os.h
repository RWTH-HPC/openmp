...
#define FTN_SET_TASK_AFFINITY_INIT_THREAD_TYPE kmpc_set_task_affinity_init_thread_type
...
#define FTN_SET_TASK_AFFINITY_INIT_THREAD_TYPE kmpc_set_task_affinity_init_thread_type_
