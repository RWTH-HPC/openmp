...
!dec$ fixedformlinesize:132
      ...
      module omp_lib
        ...
        integer (kind=omp_integer_kind), parameter :: kmp_version_build = 20140926
        character(*), parameter :: kmp_build_date    = 'No_Timestamp'
        ...
        integer (kind=omp_integer_kind), parameter :: kmp_task_aff_init_thread_type_first = 0
        integer (kind=omp_integer_kind), parameter :: kmp_task_aff_init_thread_type_random = 1
        integer (kind=omp_integer_kind), parameter :: kmp_task_aff_init_thread_type_lowest_wl = 2
        integer (kind=omp_integer_kind), parameter :: kmp_task_aff_init_thread_type_round_robin = 3
        integer (kind=omp_integer_kind), parameter :: kmp_task_aff_init_thread_type_private = 4

        integer (kind=omp_integer_kind), parameter :: kmp_task_aff_map_type_thread = 0
        integer (kind=omp_integer_kind), parameter :: kmp_task_aff_map_type_domain = 1
...
!         ***
          ...
          subroutine kmpc_set_task_affinity(ptr, len) bind(c)
            import
            integer (kind=kmp_pointer_kind), value :: ptr
            integer (kind=omp_integer_kind), value :: len
          end subroutine kmpc_set_task_affinity

          subroutine kmpc_task_affinity_init(strategy_type, mode_type, affinity_schedule, affinity_num) bind(c)
            import
            integer (kind=omp_integer_kind), value :: strategy_type
            integer (kind=omp_integer_kind), value :: mode_type
            integer (kind=omp_integer_kind), value :: affinity_schedule
            integer (kind=omp_integer_kind), value :: affinity_num
          end subroutine kmpc_task_affinity_init
