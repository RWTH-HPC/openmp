...
#   endif
    ...
    /* task affinity features under evaluation */
	extern void   __KAI_KMPC_CONVENTION  kmpc_set_task_affinity(void *, int);
    ...
    extern void   __KAI_KMPC_CONVENTION  kmpc_task_affinity_init(kmp_affinity_settings_t affinity_settings);
    extern void   __KAI_KMPC_CONVENTION  kmpc_task_affinity_set_msg(char * msg);
    extern void   __KAI_KMPC_CONVENTION  kmpc_task_affinity_taskexectimes_set_enabled(int);
